...
deviation of the 1,000 sample means and report it as the empirical standard error.
Also, calculate the theoretical standard error using the population parameters and
